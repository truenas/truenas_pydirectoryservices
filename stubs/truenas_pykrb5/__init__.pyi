...
def get_ccache(*, ccache_name: str | None = ...) -> Ccache: ...
def get_init_creds_keytab(*, principal: str, keytab: str | None = ..., ccache_name: str | None = ...) -> Ccache: ...
def get_init_creds_password(*, principal: str, password: str, ccache_name: str | None = ...) -> Ccache: ...
